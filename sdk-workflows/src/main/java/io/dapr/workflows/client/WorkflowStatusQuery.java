...
public class WorkflowStatusQuery {
  ...
  private List<WorkflowRuntimeStatus> runtimeStatusList = new ArrayList<>();
   ...
   */
  public WorkflowStatusQuery setRuntimeStatusList(@Nullable List<WorkflowRuntimeStatus> runtimeStatusList) {
   ...
   *
   * @param createdTimeTo the maximum orchestration creation time to use as a filter or {@code null} 
   ...
   * @return this query object
   */
  public WorkflowStatusQuery setMaxInstanceCount(int maxInstanceCount) {
   ...
   * @return this query object
   */
  public WorkflowStatusQuery setTaskHubNames(@Nullable List<String> taskHubNames) {
   ...
   * {@link WorkflowStatusQueryResult} result.
   *
   * @param continuationToken the continuation token from the previous query
   * @return this query object
   */
  public WorkflowStatusQuery setContinuationToken(@Nullable String continuationToken) {
   ...
   * @return this query object
   */
  public WorkflowStatusQuery setInstanceIdPrefix(@Nullable String instanceIdPrefix) {
   ...
   * @return this query object
   */
  public WorkflowStatusQuery setFetchInputsAndOutputs(boolean fetchInputsAndOutputs) {
   ...
   */
  public List<WorkflowRuntimeStatus> getRuntimeStatusList() {
   ...
   *
   * @return the configured value that determines whether to fetch orchestration inputs, outputs,
   *         and custom status values
   */
